...
class TestMockUserAPI:
    ...
    def test_mock_get_users(self, mock_server: MockServer) -> None:
        """测试 Mock 服务器的 GET 请求
        ...
        with allure.step("验证响应时间"):
            elapsed_ms: float = response.elapsed.total_seconds() * 1000
    ...
    def test_mock_create_user(self, mock_server: MockServer) -> None:
        ...
        with allure.step("准备用户数据"):
            user_data: Dict[str, str] = {"name": "新用户", "email": "newuser@example.com"}
    ...
    def test_mock_update_user(self, mock_server: MockServer) -> None:
        """测试 Mock 服务器的 PUT 请求
        ...
        with allure.step("准备更新数据"):
            update_data: Dict[str, str] = {"name": "已更新", "email": "updated@example.com"}
    ...
    def test_mock_delete_user(self, mock_server: MockServer) -> None:
    ...
    def test_mock_404_error(self, mock_server: MockServer) -> None:
    ...
    def test_mock_400_error(self, mock_server: MockServer) -> None:
    ...
    def test_mock_custom_headers(self, mock_server: MockServer) -> None:
        """测试 Mock 服务器的自定义响应头
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @allure.title("测试请求验证")
    def test_mock_request_validation(self, mock_server: MockServer) -> None:
        """测试 Mock 端点的请求响应
