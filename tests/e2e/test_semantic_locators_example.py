...
class TestSemanticLocators:
    ...
    def test_smart_locator_parsing(self, page: Page) -> None:
    ...
    def test_smart_page_with_semantic_locators(self, page: Page) -> None:
    ...
    def test_locator_priority(self, page: Page) -> None:
        """测试定位器按正确优先级解析
