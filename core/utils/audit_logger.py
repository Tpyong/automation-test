...
class AuditLogger:
    ...
    def log_data_modification(self, data_type: str, action: str, user: Optional[str] = None, details: Optional[Dict[str, Any]] = None) -> None:
        """记录数据修改"""
        self.log_event(
    ...
    def log_security_event(self, event: str, severity: AuditSeverity = AuditSeverity.HIGH, details: Optional[Dict[str, Any]] = None) -> None:
        """记录安全事件"""
        self.log_event(
...
class DataRetentionPolicy:
    ...
    def cleanup_expired_events(self) -> int:
        ...
        self.audit_logger.events = [
            ...
            if self._should_retain(event, now)
        ]
