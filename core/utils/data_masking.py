...
class DataMasker:
    ...
    def __init__(self):
        self.patterns = {
            'id_card': (DataMaskingPatterns.ID_CARD_PATTERN, DataMaskingPatterns.ID_CARD_REPLACEMENT),
            'phone': (DataMaskingPatterns.PHONE_PATTERN, DataMaskingPatterns.PHONE_REPLACEMENT),
            'bank_card': (DataMaskingPatterns.BANK_CARD_PATTERN, DataMaskingPatterns.BANK_CARD_REPLACEMENT),
            ...
            'password': (DataMaskingPatterns.PASSWORD_PATTERN, DataMaskingPatterns.PASSWORD_REPLACEMENT),
        }
