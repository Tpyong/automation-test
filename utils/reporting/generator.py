...
from utils.reporting.history_manager import HistoryManager
from utils.reporting.models import TestResult
from utils.reporting.worker_merger import WorkerMerger
...
class ReportGenerator:
    ...
    def _prepare_trend_data(self, history_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        durations = []
        skipped_tests = []
        module_data: Dict[str, Dict[str, List[float]]] = {}
